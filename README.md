...
# IMPORTANT!
This fork is no longer active. [crm-powerbi-viewer](crm-powerbi-viewer.heiigjen.com) which used to have a dependency on this fork have implemented an alternative
approach. Thus this fork wil no longer be maintained. 
